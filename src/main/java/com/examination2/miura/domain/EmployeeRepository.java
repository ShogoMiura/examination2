...
public interface EmployeeRepository {
  ...
  /**
   * データベースからすべての従業員のリストを取得します。
   *
   * @return すべての従業員を表すEmployeeオブジェクトのリスト
   */
   ...
   *
   * @param id 従業員ID
   * @return データベースから取得したOptionalのEmployeeオブジェクト・従業員が見つからなかった場合は空のOptional
   */
   ...
   * データベースに従業員情報を登録します。
   *
   * @param employee 登録する従業員の情報を含むEmployeeオブジェクト
   * @return 登録された従業員の情報を含むEmployeeオブジェクト
   * @throws DatabaseExecutionException SQLの実行に失敗した場合に投げられます
   */
  Employee createEmployee(Employee employee);

  /**
   * データベースから指定したIDの従業員情報を更新します。
   *
